...
bio.mat <- bio.mat[bio.mat$month %in% c(5:11),]    # assuming maturity-at-age does not evolve over six months? increase number of immature fish in samples and reduces uncertainty. 
...
# run models
mods <- lapply(unique(bio.mat$year), function(x) glm(mat~age,data=bio.mat[bio.mat$year==x,],family=binomial))
...
armatrix.waa(maa.fit)+scale_color_viridis_d()
```
